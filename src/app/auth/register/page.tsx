...
import { Loader2, Eye, EyeOff, Facebook, Twitter, Instagram, Github } from "lucide-react";
            ...
            <div className="lg:col-span-7 p-12 lg:p-16 flex flex-col justify-center relative z-10">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-400 font-medium">
                        Already have an account? <Link href="/auth/login" className="text-orange-400 hover:text-orange-300 transition-colors font-bold hover:underline">Sign in</Link>
                    </p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-slate-300 ml-4">Full Name</label>
                    ...
                    <Button
                        ...
                        disabled={isLoading}
                    >
                        {isLoading ? <Loader2 className="h-6 w-6 animate-spin text-black" /> : "Sign Up"}
                    </Button>
                </form>
            </div>
