    ...
    return (
        <div className="fixed inset-0 bg-[#050505] text-white flex overflow-hidden z-[100] font-sans selection:bg-indigo-500/30">
            ...
            <div className="hidden md:block md:w-[50%] lg:w-[55%] relative border-r border-white/10 bg-gradient-to-b from-[#1a1a1a] to-[#050505] overflow-hidden">
                <Canvas camera={{ position: [0, 1.45, 1.6], fov: 30 }} shadows>
                ...
                <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 text-center pointer-events-none">
                    <h3 className="text-lg font-bold text-white tracking-wide drop-shadow-lg">AI Interviewer</h3>
                    <div className="flex items-center justify-center gap-2 mt-2">
                        ...
                        <span className="text-xs font-medium uppercase tracking-widest text-slate-400 drop-shadow-md">
